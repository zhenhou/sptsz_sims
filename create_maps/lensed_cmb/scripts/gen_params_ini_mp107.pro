PRO gen_params_ini_mp107
	...
	for i=0, nsim-1 do begin
		...
		printf, 10, 'lmax = 4500'
		printf, 10, 'cls_file = .../sptsz_sims/create_maps/lensed_cmb/datalcdm_wmap7k11_lenspotentialCls.dat'  ;; Monica, you should modify this
		printf, 10, 'out_file_root = /global/scratch2/sd/hou/data/sptsz_lowl/create_maps/lensed_cmb' ;; Monica, you should modify this
	...
	for i=0, nsim-1 do begin
        ...
        ;; Monica, you should modify the following line.
		printf, 10, 'mpirun -np 32 -bynode .../sptsz_sims/create_maps/lensed_cmb/lenspix_src/simlens params/params_'+sidx+'.ini'
	endfor
	close, 10
